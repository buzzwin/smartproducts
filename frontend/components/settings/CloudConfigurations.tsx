    ...
    <div className="space-y-6">
      ...
      <Dialog open={showHelp} onOpenChange={setShowHelp}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              Complete Guide: Syncing AWS Costs to Your Product
            </DialogTitle>
            <DialogDescription>
              Step-by-step instructions for pulling AWS costs and creating cost
              records
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-6">
            <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
                Follow these steps to pull AWS costs and create cost records in
                your product:
              </p>
              <ol className="list-decimal list-inside space-y-2 text-sm text-blue-800 dark:text-blue-200">
                ...
                <li>
                  <strong>Go to your Product</strong> - Navigate to the product
                  where you want to track costs
                </li>
                <li>
                  <strong>Open Costs tab</strong> - Click on the "Costs" tab in
                  the product view
                </li>
                <li>
                  <strong>Click "Sync Cloud Costs"</strong> - Use the button to
                  open the sync dialog
                </li>
                <li>
                  <strong>Select configuration and date range</strong> - Choose
                  which costs to import
                </li>
                <li>
                ...
                <li>
                  <strong>Sync costs</strong> - Import costs as cost records in
                  your product
                </li>
                <li>
                  <strong>View and manage</strong> - Edit, categorize, and link
                  synced costs
                </li>
              </ol>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                <div>
                  <p className="font-medium mb-1">1.1 Create IAM User in AWS</p>
                  <ol className="list-decimal list-inside space-y-1 text-muted-foreground ml-2">
                    ...
                    <li>
                      Click <strong>"Create user"</strong> or select an existing
                      user
                    </li>
                    <li>
  ...
  "Statement": [{
    ...
    "Resource": "*"
                ...
                <div>
                  ...
                  <ol className="list-decimal list-inside space-y-1 text-muted-foreground ml-2">
                    <li>
                      Go to the user's <strong>Security credentials</strong> tab
                    </li>
                    <li>
                ...
                <div>
                  <p className="font-medium mb-1">1.4 Enter Credentials Here</p>
                  <ol className="list-decimal list-inside space-y-1 text-muted-foreground ml-2">
                    <li>
                      Click <strong>"Add Configuration"</strong> button above
                    </li>
                    <li>
                      Enter a name for this configuration (e.g., "Production AWS
                      Account")
                    </li>
                    <li>
                    ...
                    <li>
                      Select your AWS <strong>Region</strong> (e.g., us-east-1)
                    </li>
                    <li>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                ...
                <ol className="list-decimal list-inside space-y-1 ml-2">
                  <li>
                    Navigate to your <strong>Product</strong> in the application
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <ul className="list-disc list-inside ml-4 mt-1 space-y-1">
                      ...
                      <li>
                        Choose your <strong>active cloud configuration</strong>
                      </li>
                      <li>
                        Set the <strong>date range</strong> for costs (defaults
                        to last month)
                      </li>
                      <li>
                        (Optional) Click <strong>"Preview"</strong> to see what
                        will be imported
                      </li>
                      <li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                ...
                <li>
                  Use separate IAM users for different applications/environments
                </li>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-2">
                    ...
                    <li>Ensure Cost Explorer is enabled in your AWS account</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg p-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-green-800 dark:text-green-200">
                ...
                <li>
                  Use <strong>Preview</strong> before syncing large date ranges
                </li>
                <li>
                ...
                <li>
                  Use <strong>filters</strong> in the Costs tab to find specific
                  synced costs
                </li>
              </ul>
            </div>
